...
@property (nonatomic, njk_weak) IBOutlet id<NJKWebViewProgressDelegate>progressDelegate;
@property (nonatomic, njk_weak) IBOutlet id<UIWebViewDelegate>webViewProxyDelegate;
